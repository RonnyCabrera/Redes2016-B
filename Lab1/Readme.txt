...
1.	Captura de pantalla de los datos de la interfaz utilizada para el envío del paquete del lado del cliente (IP, Gateway, etc)
2.	Captura de pantalla de los datos de la interfaz utilizada para el envío del paquete del lado del servidor (IP, Gateway, etc)
